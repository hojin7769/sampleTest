...
const routes = [
  ...
  { path: '/classChart', name: 'classChart', component: () => import('../views/ClasstestChart.vue'), props: true },
  { path: '/chartLine', name: 'chartLine', component: () => import('../views/ChartLine.vue'), props: true }
]
